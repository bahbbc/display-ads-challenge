...
svd = decomposition.TruncatedSVD(n_components=15, algorithm='arpack')
...
for chunk in tqdm(df):
    ...
    if i == 0:
        ...
        logistic.partial_fit(principal_components, y, classes=[0,1])
    i += 1

print(logistic)
print(logistic.predict_proba(principal_components).mean())
dump(logistic, 'regularized-pca-logistic.pkl')
dump(dimensionality_reduction, 'svd-reduction.pkl')
dump(scaler, 'integer-pca-scaler.pkl')
